...
The following workflow demonstrates the **manual installation of Terraform on Windows** using the official HashiCorp ZIP package.
...
classDef command fill:#B71C1C,stroke:#7F0000,color:#FFFFFF,stroke-width:2px
classDef download fill:#6A1B9A,stroke:#351C75,color:#FFFFFF,stroke-width:2px
classDef process fill:#1565C0,stroke:#0D47A1,color:#FFFFFF,stroke-width:2px
...
subgraph STEP1["📂 Step 1 — Create Installation Folder"]
direction TB

    S1A["💻 Command Prompt"]:::process
    S1B["mkdir C:\Terraform"]:::command
...
subgraph STEP2["🌐 Step 2 — Download Terraform"]
direction TB

    S2A["🔗 HashiCorp Terraform Installation"]:::download
    S2B["🪟 Windows AMD64 ZIP"]:::download
...
subgraph STEP3["📦 Step 3 — Extract Terraform"]
direction TB

    S3A["📦 Terraform ZIP Archive"]:::process
    S3B["📂 Extract Archive"]:::process
...
subgraph STEP4["📂 Step 4 — Copy Terraform Binary"]
direction TB

    S4A["📄 terraform.exe"]:::command
    S4B["📁 C:\Terraform"]:::folder
...
subgraph STEP5["⚙️ Step 5 — Configure PATH"]
direction TB

    S5A["⚙️ Environment Variables"]:::process
    S5B["🖥️ System PATH"]:::process
    S5C["➕ Add C:\Terraform"]:::command
...
subgraph STEP6["💻 Step 6 — Verify Installation"]
direction TB

    S6A["💻 Open New Command Prompt"]:::process
    S6B["terraform version"]:::verify
...
SUCCESS(["✅ Terraform Installed Successfully"]):::success
...
style STEP1 fill:#E2F0D9,stroke:#70AD47,stroke-width:3px,color:#000000
style STEP2 fill:#EDE7F6,stroke:#6A1B9A,stroke-width:3px,color:#000000
style STEP3 fill:#E3F2FD,stroke:#1565C0,stroke-width:3px,color:#000000
style STEP4 fill:#E2F0D9,stroke:#70AD47,stroke-width:3px,color:#000000
style STEP5 fill:#E3F2FD,stroke:#1565C0,stroke-width:3px,color:#000000
style STEP6 fill:#E0F2F1,stroke:#00897B,stroke-width:3px,color:#000000
```

## 🔗 Terraform Installation Reference

```mermaid
flowchart LR

A["🌐 HashiCorp Terraform"]:::download
-->
B["📥 Download Windows AMD64 ZIP"]:::download
-->
C["📦 Extract terraform.exe"]:::process
-->
D["📂 Copy to C:\Terraform"]:::folder
-->
E["⚙️ Add C:\Terraform to PATH"]:::command
-->
F["💻 terraform version"]:::verify
-->
G["✅ Installation Verified"]:::success
...
A["🚀 Start"]:::start
-->
B["📂 Create<br/>C:\Terraform"]:::folder
-->
C["🌐 Download<br/>Terraform"]:::download
-->
D["🪟 Windows<br/>AMD64 ZIP"]:::download
-->
E["📦 Extract<br/>terraform.exe"]:::process
-->
F["📂 Copy to<br/>C:\Terraform"]:::folder
-->
G["⚙️ Configure<br/>System PATH"]:::command
-->
H["💻 terraform version"]:::verify
-->
I["✅ Terraform<br/>Installed"]:::success
...
After configuring the PATH, open a **new Command Prompt** and run:

```cmd
terraform version
```

A successful installation should return the installed Terraform version, confirming that `terraform.exe` is available through the system `PATH`.
